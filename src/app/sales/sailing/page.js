...
// Fallback "coming soon" pour la categorie Sailing (encore vide) — vraie page facon
// privat-jet "Destination inconnue" : fond gris-bleu (gray-900) + nuages. AUCUN emoji.
export const metadata = {
  title: 'Sailing Yacht Sales | Qualityacht',
  description: 'Sailing yachts for sale — selection coming soon.',
};

export default function SailingSalesPage() {
  return (
