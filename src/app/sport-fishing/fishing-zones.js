...
export const FISHING_ZONES = [
  ...
  },
  {
    ...
    coords: [18.3, -63.05],
    desc: 'Offshore grounds worked by the island’s charter fleet, a short run from the anchorages.',
  ...
  },
  {
    ...
    kind: 'Offshore — big game',
    coords: [12.45, -70.0],
    desc: 'Game fishing grounds a few miles off the coast, reached on half or full-day charters.',
