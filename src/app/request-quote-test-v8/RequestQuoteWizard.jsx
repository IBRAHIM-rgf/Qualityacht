    ...
    <div className="relative min-h-screen text-[#acb0cd] pt-24 pb-20 px-4 overflow-x-hidden">
      ...
      <div className="overflow-hidden max-w-5xl mx-auto">
        <div className="flex transition-transform duration-500 ease-in-out" style={{ transform: `translateX(-${step * 100}%)` }}>
          ...
          {/* ══ ÉTAPE 3 — THANK YOU ══ */}
          <section className="w-full shrink-0 px-1">
            <div className="max-w-2xl mx-auto text-center px-2 md:px-4 py-10 md:py-24 min-h-[80vh] md:min-h-0 flex flex-col items-center justify-between md:justify-center gap-10 md:gap-0">
              <div className="flex flex-col items-center w-full">
                <h2 className="trajan-regular font-bold text-2xl md:text-3xl uppercase tracking-[0.12em] text-[#C0C0C0] mb-8 md:mb-4">Grateful</h2>
                <div className="relative w-40 h-7 mx-auto mb-10 md:mb-6">
                  <Image src="/images/title-line.png" alt="" fill className="object-contain" />
                </div>
                <div className="w-full rounded-xl border border-[#C0C0C0] bg-black/40 px-5 py-8 md:px-8 md:py-6 md:mb-8">
              ...
              <a href="/#discovery"
                className="inline-block rounded-xl px-10 py-4 border-2 border-[#C0C0C0] bg-transparent text-[#B03E00] text-sm uppercase tracking-[0.2em] font-medium transition-all hover:bg-[#B03E00]/10 shadow-[0_4px_15px_rgba(192,192,192,0.3)] hover:shadow-[0_6px_20px_rgba(192,192,192,0.4)]">
                Back to Homepage
              </a>
            </div>
          </section>
