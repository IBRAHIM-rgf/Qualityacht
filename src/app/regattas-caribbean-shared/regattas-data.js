...
export const REGATTAS_2027 = [
  ...
  {
    id: 'coral-reef-regatta',
    name: 'CORAL Reef Regatta',
    dates: 'April 2027',
    month: 'april',
    island: 'Belize',
    categories: ['offshore'],
    ...
    audience: 'Amateurs',
    description: {
      island: 'Held off Belize, along the second-largest barrier reef in the world.',
      race: 'Relaxed racing suited to amateurs, over turquoise reef waters.',
    },
    footer: 'Barrier reef · Beginner-friendly',
  },
  {
    id: 'cap-martinique',
    name: 'Cap Martinique',
  ...
  },
  {
    ...
    dates: 'November 2026',
    month: 'november',
    island: 'Saint-Malo → Pointe-à-Pitre (Guadeloupe)',
    categories: ['offshore', 'superyacht'],
    boatTypes: 'Monohulls (IMOCA, Class40), multihulls (Ultim, Multi50)',
    level: 'Very High',
    audience: 'Professionals',
    description: {
      island: 'Legendary solo transatlantic from Saint-Malo to Pointe-à-Pitre, Guadeloupe. Held every 4 years.',
      race: 'Solo offshore across the Atlantic. IMOCA, Class40, Ultim and Multi50 fleets.',
    },
    footer: 'Solo transatlantic · Every 4 years',
  },
  {
