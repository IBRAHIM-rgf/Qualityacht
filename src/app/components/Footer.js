      ...
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 text-sm">
        ...
        <div>
          <Image
            ...
            height={50}
          />
          <h2 className="text-xl font-bold text-orange-500 mt-2">QUALITYACHT</h2>
        </div>
        ...
        <div>
          ...
          <h3 className="font-semibold mt-5 mb-3 uppercase underline decoration-[#f97316] underline-offset-8 text-sm tracking-wider">Other Charters</h3>
          <ul className="space-y-2 text-[#acb0cd]">
        ...
        {/* Destinations */}
        <div>
          <h3 className="font-semibold mb-3 uppercase underline decoration-[#f97316] underline-offset-8 text-sm tracking-wider">Destinations</h3>
          <ul className="space-y-2 text-[#acb0cd]">
        ...
        {/* Contact */}
        <div>
          <h3 className="font-semibold mb-3 uppercase underline decoration-[#f97316] underline-offset-8 text-sm tracking-wider">Contact</h3>
          <ul className="space-y-2 text-[#acb0cd]">
