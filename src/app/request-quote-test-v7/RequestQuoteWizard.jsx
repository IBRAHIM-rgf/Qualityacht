    ...
    <div className="relative min-h-screen text-[#acb0cd] pt-24 pb-20 px-4 overflow-x-hidden">
      ...
      <div className="overflow-hidden max-w-5xl mx-auto">
        <div className="flex transition-transform duration-500 ease-in-out" style={{ transform: `translateX(-${step * 100}%)` }}>
          ...
          {/* ══ ÉTAPE 3 — THANK YOU ══ */}
          <section className="w-full shrink-0 px-1">
            <div className="max-w-2xl mx-auto text-center py-12 md:py-24 px-2 md:px-4">
              <h2 className="trajan-regular font-bold text-2xl md:text-3xl uppercase tracking-[0.12em] text-[#C0C0C0] mb-6 md:mb-4">Grateful</h2>
              <div className="relative w-40 h-7 mx-auto mb-8 md:mb-6">
                <Image src="/images/title-line.png" alt="" fill className="object-contain" />
              </div>
              <p className="text-[#B03E00] leading-loose md:leading-relaxed mb-10 md:mb-8 px-2">
                Your request for <span className="text-[#acb0cd] uppercase">{yacht.name}</span> has been received.
