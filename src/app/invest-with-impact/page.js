      ...
      <section className="px-6 md:px-14 pb-16 md:pb-24">
        <div className="max-w-3xl mx-auto rounded-2xl border border-[#C0C0C0]/25 bg-[#2e2f32] p-8 md:p-10 text-center">
          ...
          <a
            ...
            className={`mt-6 inline-flex min-h-[48px] items-center justify-center rounded-xl border border-[#C0C0C0]/40 bg-[#26272a] px-6 py-3 transition-colors hover:border-[#c2622a] ${FOCUS}`}
          >
            <Image
              src={PARTNER.logo}
              alt={PARTNER.name}
