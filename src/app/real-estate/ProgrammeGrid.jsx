    ...
    <section className="px-6 md:px-14 py-16 md:py-20 bg-[#26272a]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          <p className="text-sm md:text-base uppercase tracking-[0.24em] text-[#B87333] font-medium mb-2">Dubai</p>
          ...
          {DUBAI_PROGRAMMES.map((p) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-1">
                <h3 className="trajan-regular text-xl md:text-2xl uppercase tracking-[0.08em] text-[#C0C0C0] leading-snug">
                  {p.name}
                </h3>
                {p.developer && (
                  <p className="mt-2 text-[15px] uppercase tracking-[0.16em] text-[#B87333]">{p.developer}</p>
                )}
