...
export default function CaribbeanV16Page({
  ...
  return (
    <>
      ...
      <div className="bg-[#26272a] text-[#acb0cd] overflow-x-clip">
        ...
        {/* ══ SCROLL LATERAL facon Mamounia (remplace le bandeau cocomer) ══
            Private Jet · Horses & Riding · Fine Food & Dining · Historic Sites */}
        <HorizontalPanels />
