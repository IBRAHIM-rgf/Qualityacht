      ...
      <div className="bg-[#26272a] text-[#acb0cd] overflow-x-hidden">
        ...
        <CloudSection className="bg-[#26272a] py-14 md:py-28 px-5 md:px-20" bg="/images/nuagesAncien.png">
          <div className="max-w-4xl mx-auto text-center leading-relaxed space-y-5 md:space-y-6">
            <p className="text-lg md:text-2xl text-[#22c55e]">
            ...
            <p className="text-base md:text-xl max-w-3xl mx-auto text-[#22c55e]">
            ...
            <p className="text-base md:text-xl max-w-2xl mx-auto text-[#22c55e]">
            ...
            <p className="text-sm md:text-lg max-w-xl mx-auto text-[#22c55e]">
