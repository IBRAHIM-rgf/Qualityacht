  ...
  return (
    <div className="bg-[#26272a] text-[#acb0cd] overflow-x-hidden">
      ...
      <div className="relative">
        {/* Fondu haut depuis le hero */}
        <div className="absolute top-0 left-0 right-0 h-24 pointer-events-none z-10" style={{ background: 'linear-gradient(to bottom, #26272a, transparent)' }} />
        {/* Fondu bas vers la section suivante */}
        <div className="absolute bottom-0 left-0 right-0 h-24 pointer-events-none z-10" style={{ background: 'linear-gradient(to top, #26272a, transparent)' }} />
      <div
