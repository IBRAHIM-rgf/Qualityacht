// ══ /charters/group/carribbean ══
//
// Route DEDIEE au funnel Group. La route generique /charters/carribbean n'est
// pas touchee : le contenu Group ne doit pas contaminer les autres funnels.
//
// Aucun composant global n'est utilise ni modifie : le hero video et la galerie
// sont deux composants locaux a cette route.
//
// Regle editoriale : aucune promesse inventee. Rien n'est affirme sur la
// disponibilite, les prix ou la capacite.

import HeroVideo from './HeroVideo';
import GroupGallery from './GroupGallery';

export const metadata = {
  title: 'Group Yacht Charters in the Caribbean | Qualityacht',
  description:
    'Private group charters across the Caribbean, arranged by Qualityacht around your dates, your islands and the size of your party.',
};

const HERO_VIDEO = '/media/client/lydie/2026-08-27/group-caribbean/hero/group-caribbean-hero.mp4';
const HERO_POSTER = '/media/client/lydie/2026-08-27/group-caribbean/hero/group-caribbean-hero-poster.webp';
...
export default function GroupCaribbeanPage() {
  return (
      ...
      <section className="relative w-full pt-[70px] md:pt-0 h-[74vh] min-h-[480px] md:h-[86vh] overflow-hidden bg-[#26272a]">
        ...
        <div className="absolute inset-x-0 bottom-0 flex flex-col items-center text-center px-5 pb-10 md:pb-16">
          <h1 className="trajan-regular text-2xl md:text-5xl lg:text-6xl uppercase tracking-[0.1em] md:tracking-[0.12em] text-[#acb0cd] leading-tight max-w-4xl drop-shadow-[0_2px_10px_rgba(0,0,0,0.85)]">
            Group Yacht Charters in the Caribbean
          </h1>
      ...
      <section className="px-6 md:px-14 pb-20 md:pb-28">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            {[
              {
                titre: 'One Party, One Yacht',
                texte:
                  'The whole group aboard the same vessel, rather than split across several. What fits depends on the yacht and on your dates, and we check both before proposing anything.',
              },
              {
                titre: 'Islands Within Reach',
                texte:
                  'The Caribbean puts a great deal within a short passage. Itineraries are shaped around what your group actually wants from the week, not around a fixed route.',
              },
              {
                titre: 'Arranged, Not Improvised',
                texte:
                  'Crew, provisioning and the days ashore are organised in advance. Availability and local rules are confirmed before anything is promised.',
              },
            ].map((c) => (
              <article
                key={c.titre}
