// Les 10 sites historiques detailles de Jamaique (contenu complet, ex-page canonique
// /historic-sites/caribbean). Rendu par /historic-sites/caribbean/monuments.
...
export default function MonumentsDetail() {
  return (
    <>
      {/* INTRO */}
